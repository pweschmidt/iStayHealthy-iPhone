...
- (void)createJSONFromModelWithName:(NSString *)modelName
{
	...
	{
		[[CoreDataManager sharedInstance] fetchDataForEntityName:modelName predicate:nil sortTerm:sortTerms ascending:[ascending boolValue] completion: ^(NSArray *array, NSError *error) {
		    if (nil != array)
		    {
