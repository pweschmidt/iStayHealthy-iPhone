...
- (void)viewDidLoad
{
	...
	CGFloat xOffset = frame.size.width / 2 - 90;
	UIImageView *logoView = [[UIImageView alloc]
	                         initWithImage:[UIImage imageNamed:@"icon_50_flat.png"]];
	logoView.layer.cornerRadius = 10;
	logoView.layer.masksToBounds = YES;
	logoView.frame = CGRectMake(xOffset - 60, 100, 50, 50);

	[self.view addSubview:logoView];

	UILabel *titleLabel = [UILabel standardLabel];
	titleLabel.frame = CGRectMake(xOffset, 120, 300, 50);
	titleLabel.text = @"iStayHealthy";
	titleLabel.textAlignment = NSTextAlignmentLeft;
	titleLabel.font = [UIFont fontWithName:@"Helvetica-Light" size:45];
	[self.view addSubview:titleLabel];

	UILabel *versionLabel = [UILabel standardLabel];
	versionLabel.frame = CGRectMake(xOffset, 180, 280, 20);
	...
	UITextField *passwordField = [[UITextField alloc] initWithFrame:CGRectMake(xOffset, 265, 280, 40)];
	...
	forgottonButton.frame = CGRectMake(xOffset, 325, 300, 44);
