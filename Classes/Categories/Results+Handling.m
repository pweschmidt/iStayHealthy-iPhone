...
- (void)importFromDictionary:(NSDictionary *)attributes
{
    ...
    self.kidneyGFR = [self numberFromValue:[attributes objectForKey:kKidneyGFR]];
...
- (NSString *)xmlString
{
    ...
    [string appendString:[self xmlAttributeString:kKidneyGFR attributeValue:self.kidneyGFR]];
...
- (void)addValueString:(NSString *)valueString type:(NSString *)type
{
    ...
    else if ([type isEqualToString:kKidneyGFR])
    {
        self.kidneyGFR = value;
    }
}
...
- (NSString *)valueStringForType:(NSString *)type
{
    ...
    {
        return [NSString stringWithFormat:@"%3.2f", [self.HeartRate floatValue]];
    }
    ...
    else if ([type isEqualToString:kHepCViralLoad] && 0 < [self.HepCViralLoad floatValue])
    {
        ...
        {
            return [NSString stringWithFormat:@"%9.2f", [self.HepCViralLoad floatValue]];
        }
    }
    ...
    else if ([type isEqualToString:kKidneyGFR] && 0 < [self.kidneyGFR floatValue])
    {
        return [NSString stringWithFormat:@"%6.2f", [self.kidneyGFR floatValue]];
    }
    return valueString;
}
