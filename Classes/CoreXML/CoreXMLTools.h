...
/**
   As methods below, this does a validation of XML data before parsing.
   It takes in an NSData XML object and returns a validated xml Data object or nil with error
   @param xmlData
   @param error
