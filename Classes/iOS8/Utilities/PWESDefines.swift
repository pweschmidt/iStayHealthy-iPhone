...
typealias PWESSuccessWithDictionaryClosure = (_ success: Bool, _ dictionary: NSDictionary?, _ error: NSError?) -> Void
typealias PWESArrayClosure = (_ array: NSArray?, _ error: NSError?) -> Void
